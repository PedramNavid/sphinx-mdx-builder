...
__version__ = importlib.metadata.version("sphinxcontrib-mdxbuilder")
...
def setup(app: Sphinx):
    ...
    app.add_config_value(
        "mdx_github_url", None, "env"
    )

    app.add_config_value("mdx_show_source_links", True, "env")

    # Default title to use when document has no title
    app.add_config_value("mdx_default_title", "Documentation", "env")
